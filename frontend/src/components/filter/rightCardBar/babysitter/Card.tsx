  ...
  return (
    <div className="">
      {showSkeleton ? (
        ...
        <div className=" md:w-[450px] dark:bg-[#4D565E] h-fill md:flex-row md:px-0 px-16 md:pb-0 pb-12 flex flex-col items-center  rounded-2xl overflow-hidden shadow-xl bg-[#F6F9FA] mb-[40px] ">
          ...
          <div className="w-[150px] h-[150px] ml-[5px] md:-mt-[24px] ">
            <div className="flex gap-5">
              <div className="text-lg font-semibold text-[#31393F] dark:text-white w-[150px] flex flex-wrap">
                {data.name}
              </div>
              <Rating
                // sx={{ color: "#59BEC9" }}
