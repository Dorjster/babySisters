...
const Cards2 = () => {
  return (
    <div className=" md:flex-row md:gap-[50px] bg-white dark:bg-[#222831]   w-screen flex flex-col  items-center justify-center w-screeen -mt-[10px] relative pt-10 ">
      <div className=" shadow-lg w-[400px] h-fill rounded-2xl  flex flex-col items-center mt-[100px]  p-4 dark:bg-[#4D565E]">
