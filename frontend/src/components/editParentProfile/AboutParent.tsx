...
export const AboutParent = (props: About) => {
    ...
    const handleVerifyUser = async () => {
        try {
            const { data } = await AxiosInstance.post<UserVerifyData>(
                "/verifyUser",
                {
                ...
                {loggedInUserData?.verification === true ? (
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 pt-2">
                            Таны имэйл хаяг руу илгээсэн нууц үгийг хийснээр
                            таны хаяг баталгаажих болно.
                        </p>
                    </div>
                )}
